...
public class GameJob extends Configured implements Tool {


    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new GameJob(), args));
    }
     ...
     * algorithm {@code GameReducer#reduce()} as by both Combiner and Reducer. Checkout line 94 and line 96.
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(configuration, "5 stars number");

        //Set Map Reduce main jobconf class
        job.setJarByClass(GameJob.class);

        //Set Mapper class
        job.setMapperClass(GameIMCMapper.class);

        //Set Combiner class
        job.setCombinerClass(GameIMCReducer.class);
